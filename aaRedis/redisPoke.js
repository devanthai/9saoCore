...
subscriber.subscribe('addTop', async (message) => {
...
//     time: 1659259538321
subscriber.subscribe('addHis', async (message) => {
    try {
        ...
        else if (dataSend.goldBet == 10000000) {
            muccuoc = 2
        }
        else {
            muccuoc = 3
...
//     afterBet: 775772000000,
//     time: 1659259538321
subscriber.subscribe('addHisTrungHu', async (message) => {
    try {
        var dataSend = JSON.parse(message)
